...
const WarRoomChart = ({ dataPoints }) => {
    ...
    if (!hasData) {
        return (
            <div className="h-full w-full flex flex-col items-center justify-center border-2 border-dashed border-white/5 rounded-2xl bg-slate-950/20">
                ...
                <p className="text-[8px] text-slate-700 mt-2 uppercase tracking-widest font-bold">Inscrivez vos premières transactions pour cartographier votre empire</p>
            </div>
        );
    }
    ...
    const options = {
        ...
        plugins: {
            ...
            tooltip: {
                ...
                displayColors: false,
                callbacks: {
                    label: (context) => ` Trésor: ${context.raw.toLocaleString()} FCFA`,
                },
            },
        },
        scales: {
